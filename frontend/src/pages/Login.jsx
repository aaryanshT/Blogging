      ...
      <div className="w-96 bg-white bg-opacity-70 backdrop-blur-md p-6 rounded-lg shadow-md">
        ...
        <div className="mb-4">
          <label className="flex items-center gap-2 border-b border-gray-300 py-2">
            ...
            <input type="email" className="grow bg-transparent outline-none text-black custom-input" placeholder="Email" />
          </label>
        </div>
        ...
        <div className="mb-4">
          <label className="flex items-center gap-2 border-b border-gray-300 py-2">
            ...
            <input type="text" className="grow bg-transparent outline-none text-black custom-input" placeholder="Username" />
          </label>
        </div>
        ...
        <div className="mb-6">
          <label className="flex items-center gap-2 border-b border-gray-300 py-2">
            ...
            <input type="password" className="grow bg-transparent outline-none text-black custom-input" placeholder="Password" />
          </label>
        </div>
